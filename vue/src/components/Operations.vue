    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
			...
			<h2>Overview</h2>
			<p class="intro">The Operations track focuses on helping you become well versed in the IT infrastructe side of web app development. This includes IT support as well as cloud (AWS) and phisical server hosting.</p>
			<p><strong>Mentors: </strong>Lisa Smith, Andrew Hamilton, Dr. Steve Fitzgerald</p>
